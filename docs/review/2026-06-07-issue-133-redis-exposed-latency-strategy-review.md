...
| 5 Testability | Validation mapping | plan은 targeted JaVers module tests를 매핑하고, generic cache behavior가 sibling `bluetape4k-exposed` fixture에서 계속 커버되는 이유를 설명한다. | P0=0, P1=0, P2=0, P3=0 |
