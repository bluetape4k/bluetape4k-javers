...
- Staged manual mirrors: 21 canonical pairs target the future 0.3 manual; the stable 0.2 manifest keeps them inactive and creates zero mirror files.
...
- Version authority: stable manual `0.2.1` / minor `0.2`; canonical README diagrams describe the `0.3.0` develop line, so `targetMinor: 0.3` blocks premature reuse.
...
- Manual mirror: staged for minor 0.3; inactive while the stable manual remains 0.2.
