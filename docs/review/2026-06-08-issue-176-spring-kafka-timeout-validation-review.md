# Issue #176 - Spring Kafka Timeout 검증 검토
...
| 4 Kotlin/API 품질 | 검증과 constructor behavior | Public construction boundary는 이제 fail fast한다. `KafkaSnapshotEventPublisher`는 `init` validation 대신 private constructor와 companion `invoke`를 사용한다. | P0=0, P1=0, P2=0, P3=0 |
